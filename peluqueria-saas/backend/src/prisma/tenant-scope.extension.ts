 ...
 * - User / Branch / Client / Professional / Subscription /
 ...
 * - ClientNote / ProfessionalSchedule: no tienen tenantId propio (cuelgan
 *   de Client.tenantId / Professional.tenantId), así que no se interceptan
 *   acá — el service correspondiente valida la pertenencia del padre antes
 *   de leer/crear (mismo motivo que Role con findUnique, doc
 *   `10-CLIENTES.md` §4).
